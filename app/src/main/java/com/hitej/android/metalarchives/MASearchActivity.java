 ...
 *
 * Hosts all related search fragments. Bundle
 */
public class MASearchActivity extends SingleFragmentActivity {

    private static final String TAG = "MASearchActivity";
    ...
    public static Intent newIntent(Context context, String searchType) {
        Intent intent = new Intent(context, MASearchActivity.class);
